...
//  Pirate Fleet
//
//  Modified by Scott Baumbich on 8/25/15.
...
struct Settings {
    ...
    struct Messages {
        ...
        static let ComputerHitSpecialMine = "The computer hit a special mine! You've been awarded a direct hit on your next turn."
        static let HumanHitMonster = "You've awakened a Sea Monster! This giant marine reptile is coming for your ships! The Computers next turn will be a direct hit."
        static let ComputerHitMonster = "The Computer has awakened a Sea Monster! You will be rewarded with a direct hit on your next turn!"
