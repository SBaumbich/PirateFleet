...
//  Pirate Fleet
//
//  Modified by Scott Baumbich on 8/14/15.
...
// TODO:Uncomment once PenaltyCell protocol has been implemented
            ...
            // mine penalty
             if let mine = penaltyCell as? Mine {
                ...
                if mine.guaranteesHit{
                    
                    let alertMessage = (player.playerType == .human) ? Settings.Messages.HumanHitMine : Settings.Messages.ComputerHitSpecialMine
